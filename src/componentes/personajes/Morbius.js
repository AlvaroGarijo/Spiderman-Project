         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/Black_Cat"><button className='buttonNavigation'><FaArrowLeft/> Black Cat</button></Link>
                        <br/>
                    <Link to="/personaje/Camaleon"><button className='buttonNavigation'>Camaleón <FaArrowRight/> </button></Link> 
                </div>
            </div>
        </div>
        </div>
