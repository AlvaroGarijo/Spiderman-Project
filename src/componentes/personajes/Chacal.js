         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/Camaleon"><button className='buttonNavigation'><FaArrowLeft/> Camaleón</button></Link>
                        <br/>
                    <Link to="/personaje/Morlun"><button className='buttonNavigation'>Morlun <FaArrowRight/> </button></Link>
                </div>
            </div>
        </div>
        </div>
