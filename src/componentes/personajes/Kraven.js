         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/Kingpin"><button className='buttonNavigation'><FaArrowLeft/> Kingpin</button></Link>
                        <br/>
                    <Link to="/personaje/MrNegativo"><button className='buttonNavigation'>Mr.Negativo <FaArrowRight/> </button></Link>
                </div>
            </div>
        </div>
        </div>
