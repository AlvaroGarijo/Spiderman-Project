        ...
        <div className='personWrap1'>
            ...
            <div className='dataWrap'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/SpiderWomanMattie"><button className='buttonNavigation'><FaArrowLeft/>  Spider Woman (Mattie)</button></Link>
                            <br/>
                    <Link to="/personaje/SpiderHam"><button className='buttonNavigation'>Spider Ham <FaArrowRight/></button></Link> 
                </div>
        </div>
        </div>
        </div>
