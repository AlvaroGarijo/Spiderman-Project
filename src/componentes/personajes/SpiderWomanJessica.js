        ...
        <div className='personWrap1'>
            ...
            <div className='dataWrap'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/SpidermanSuperior"><button className='buttonNavigation'><FaArrowLeft/>  Spiderman Superior</button></Link>
                            <br/>
                    <Link to="/personaje/SpiderWomanMattie"><button className='buttonNavigation'>Spider Woman (Mattie) <FaArrowRight/></button></Link> 
                </div>
        </div>
        </div>
        </div>
