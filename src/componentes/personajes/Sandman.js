         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <a href="/personaje/Mysterio"><button className='buttonNavigation'><FaArrowLeft/></button></a>
                    <br/>
                    <a href="/personaje/Lagarto"><button className='buttonNavigation'><FaArrowRight/></button></a>
                </div>
            </div>
        </div>
        </div>
