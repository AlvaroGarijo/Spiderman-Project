         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/Mysterio"><button className='buttonNavigation'><FaArrowLeft/> Mysterio</button></Link>
                        <br/>
                    <Link to="/personaje/Lagarto"><button className='buttonNavigation'>Lagarto <FaArrowRight/> </button></Link>  
                </div>
            </div>
        </div>
        </div>
