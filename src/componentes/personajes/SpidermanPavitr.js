        ...
        <div className='personWrap1'>
            ...
            <div className='dataWrap'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/SpiderHam"><button className='buttonNavigation'><FaArrowLeft/>  Spider Ham</button></Link>
                            <br/>
                    <Link to="/personaje/spidermanManga"><button className='buttonNavigation'>Spiderman Manga <FaArrowRight/></button></Link> 
                </div>
        </div>
        </div>
        </div>
