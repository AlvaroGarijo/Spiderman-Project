         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/MrNegativo"><button className='buttonNavigation'><FaArrowLeft/> Mr.Negativo</button></Link>
                        <br/>
                    <Link to="/personaje/Black_Cat"><button className='buttonNavigation'>Black Cat <FaArrowRight/> </button></Link>  
                </div>
            </div>
        </div>
        </div>
