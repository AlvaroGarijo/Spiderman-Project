         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/Escorpion"><button className='buttonNavigation'><FaArrowLeft/> Escorpión</button></Link>
                        <br/>
                    <Link to="/personaje/HobGoblin"><button className='buttonNavigation'>Hob Goblin <FaArrowRight/> </button></Link> 
                </div>
            </div>
        </div>
        </div>
