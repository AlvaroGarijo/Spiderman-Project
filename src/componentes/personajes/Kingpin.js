         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/HobGoblin"><button className='buttonNavigation'><FaArrowLeft/> HobGoblin</button></Link>
                        <br/>
                    <Link to="/personaje/Kraven"><button className='buttonNavigation'>Kraven <FaArrowRight/> </button></Link>
                </div>
            </div>
        </div>
        </div>
