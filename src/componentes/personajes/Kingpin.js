         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <a href="/personaje/HobGoblin"><button className='buttonNavigation'><FaArrowLeft/></button></a>
                    <br/>
                    <a href="/personaje/Kraven"><button className='buttonNavigation'><FaArrowRight/></button></a>
                </div>
            </div>
        </div>
        </div>
