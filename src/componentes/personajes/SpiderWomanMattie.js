        ...
        <div className='personWrap1'>
            ...
            <div className='dataWrap'>
                ...
                <div className='navegationPerson'> 
                    ...
                    <a href="/personaje/SpiderWomanJessica"><button className='buttonNavigation'><FaArrowLeft/></button></a>
                    <br/>
                    <a href="/personaje/SpidergirlMayday"><button className='buttonNavigation'><FaArrowRight/></button></a>
                </div>
        </div>
        </div>
    </div>
