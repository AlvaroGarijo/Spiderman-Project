         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/Lagarto"><button className='buttonNavigation'><FaArrowLeft/> Lagarto</button></Link>
                    <br/>
                    <Link to="/personaje/Escorpion"><button className='buttonNavigation'>Escorpión <FaArrowRight/></button></Link>
                </div>
            </div>
        </div>
        </div>
