         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'> 
                    <Link to="/personaje/Buitre"><button className='buttonNavigation'><FaArrowLeft/> Buitre</button></Link>
                        <br/>
                    <Link to="/personaje/Rhino"><button className='buttonNavigation'>Rhino <FaArrowRight/> </button></Link>
