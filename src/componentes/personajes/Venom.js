         ...
         <div className='dataWrap'>
            <div className='dataControl'>
                ...
                <div className='navegationPerson'>
                    <Link to="/personaje/Dr_Octopus"><button className='buttonNavigation'><FaArrowLeft/> Dr.Octopus</button></Link>
                        <br/>
                    <Link to="/personaje/Carnage"><button className='buttonNavigation'>Carnage <FaArrowRight/> </button></Link>   
                </div>
            </div>
        </div>
        </div>
