      ...
      <div className='wrappSpider'>
        <div className='wrapp1'>
          ...
          <div className='dataSpider linksSpiderData'>
              <a  className='linkSpiderData' href='/familia'> <GiSpiderMask className='icon1'/> Familia <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/interesAmoroso'> <GiSpiderMask className='icon1'/> Intereses Amorosos <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/personajesSecundarios'> <GiSpiderMask className='icon1'/> Personajes Secundarios <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/marvel'><GiSpiderMask className='icon1'/> Aliados en MARVEL <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/villanos'><GiSpiderMask className='icon1'/> Villanos <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/spiders'><GiSpiderMask className='icon1'/> Continuidades Alternativas "Spider-Verse" <GiSpiderMask className='icon1'/></a>
              <a className='linkSpiderData' href='/personajeApoyo'><GiSpiderMask className='icon1'/> Personajes de Apoyo <GiSpiderMask className='icon1'/></a>
          </div>
