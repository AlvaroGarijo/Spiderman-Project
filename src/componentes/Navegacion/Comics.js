...
export const Comics = () => {
  return (
    <div className='spider'>
      <h1 className='titleSpider'>Cómics</h1>
      <div className='wrappComic'>
          ...
          <div className='wrapperComic2'>
            ...
            <p className='introGuia'>Podéis encontrar todos los volumenes de Spiderman en la <a className='linkGuia' target='_blank' href='https://www.whakoom.com/guemar/lists/spider-man_-_guia_de_lectura_definitiva_4868'>Guía Definitiva</a> con más de 600 Volúmenes de Spideay ordenado por colecciones</p>
          </div>
      </div>
    </div>
  )
